  ...
  public async start(): Promise<void> {
    ...
    this.startPromise = (async () => {
      try {
        ...
        // Load build info generated by ssr:generate:build-info, which always runs first in ssr:build.
        // In HMR mode the file may not exist — loadBuildInfo skips the import and returns DEFAULT_BUILD_INFO.
