...
.claude/**/*.local*
# Machine-local Claude Code state: launch.json is a generated dev server command
# and port, and worktrees holds throwaway agent checkouts. Shared config such as
# settings.json, agents, commands, and skills stays committed.
.claude/launch.json
.claude/worktrees/
