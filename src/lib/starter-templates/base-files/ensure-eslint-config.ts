...
export default [
  ...
  },
  {
    ...
    rules: {
      ...
      // They are here because COOP, CORP, and SPA are web vocabulary you are
      // likely to meet, but it does mean \`myCorp\` is refused too. This file is
      // yours: drop an entry you do not want.
