...
export class APIServerComponent extends BaseComponent {
    ...
    this.startPromise = (async () => {
      try {
        ...
        this.server = serveAPI({
          ...
          // See: https://github.com/keverw/unirend/blob/main/docs/ssr.md (Standalone API section)
          //
          ...
          // See: https://github.com/keverw/unirend/blob/main/README.md#toolchain-recommendation
          // and https://github.com/keverw/unirend/blob/main/docs/websockets.md
          //
          ...
          // See: https://github.com/keverw/unirend/blob/main/docs/file-upload-helpers.md
          //
          // fileUploads: {
          //   enabled: true,
  ...
  private registerRoutes(server: APIServer) {
    ...
    //
    // See: https://github.com/keverw/unirend/blob/main/docs/ssr.md (Custom API Routes)
