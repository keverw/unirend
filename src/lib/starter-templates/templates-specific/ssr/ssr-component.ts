...
export class SSRServerComponent extends BaseComponent {
  ...
  // See: https://github.com/keverw/unirend/blob/main/docs/ssr.md
  ...
  public async start(): Promise<void> {
    ...
    this.startPromise = (async () => {
      try {
        ...
        // the import. See: https://github.com/keverw/unirend/blob/main/docs/build-info.md
        ...
        const sharedConfig = {
          ...
          // See: https://github.com/keverw/unirend/blob/main/docs/client-identity.md
          ...
          // See: https://github.com/keverw/unirend/blob/main/docs/build-info.md
          publicAppConfig: {
          ...
          //
          // Error page customization — see: https://github.com/keverw/unirend/blob/main/docs/ssr.md
          //
