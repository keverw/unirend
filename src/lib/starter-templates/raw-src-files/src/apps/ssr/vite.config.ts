...
export default defineConfig((configEnv) => {
  ...
  return withUnirendViteConfig({
    ...
    plugins: [
      ...
      !isSSRBuild &&
        visualizer({
          filename: resolve(__dirname, '../../../build/ssr/client-stats.html'),
          template: 'treemap',
          gzipSize: true,
          brotliSize: true,
        }),
      !isSSRBuild &&
        visualizer({
          filename: resolve(
            __dirname,
            '../../../build/ssr/client-stats-app.html',
          ),
          template: 'treemap',
          gzipSize: true,
          brotliSize: true,
      ...
      !isSSRBuild &&
        visualizer({
          filename: resolve(
            __dirname,
            '../../../build/ssr/client-stats-deps.html',
          ),
          template: 'treemap',
          gzipSize: true,
          brotliSize: true,
    ...
    build: {
      ...
      outDir: resolve(__dirname, '../../../dist/apps/ssr/set-via-cli-instead'),
      emptyOutDir: true,
